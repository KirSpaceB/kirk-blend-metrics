...
interface PhoneNumberDraggableCardProps extends Setting {
  advanced: boolean;
  onDrag?: (e: React.PointerEvent<HTMLButtonElement>) => void;
  active: boolean;
}

export const PhoneNumberDraggableCard = (
  props: PhoneNumberDraggableCardProps
) => {
  const {
    onDrag,
    advanced,
  ...
  const handleClick = () => {
    send({ ...options, type: "EDIT-PHONE-NUMBER" });
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow">
        ...
        <div className="pointer-events-none mt-[11.5px] flex items-center">
